...
class DB  
{
    ...
    public function findFirst($table, $params=[], $class=false){
        if($this->_read($table, $params, $class)) {
            return $this->firstOfResult(); 
        }
        return false;
    }

    // I STOPED HERE FOR NOW BUT THE IDEA IS TO CREATE A FUNCTION TO SELECT SOME COLUMNS FROM THE DATABASE
    // public function findSomeColumn($table, $columns=[], $params=[], $class=false){
    //     if($this->_read($table, $params, $class)) {
    //         return $this->results();
    //     }
    //     return false;
