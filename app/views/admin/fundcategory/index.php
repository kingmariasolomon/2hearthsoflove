...
<section class="uk-section uk-section-xsmall uk-dark">
    <div class="section-heading uk-margin-bottom">
        <div class="uk-container">
            <h2 class="uk-heading-bullet"><span class="txt-grad3"> Fund Categories</h2>
            ...
            <div class="uk-grid-small uk-child-width-1-1" uk-grid>
                ...
                <?php if(!empty($this->fundcat)): ?>
                    <table class="uk-table uk-table-divider">
                        ...
                        <tbody>
                        <?php foreach($this->fundcat as $key => $val): ?>
                            <tr>
                                <td>
                                ...
                                <td><?=($val->parent==0)? "Parent Category": "Child Category";?></td>
                                <td>
                                    <a href="<?=PROOT?>funding/editFundCat/<?=$val->id?>" class="uk-text-success no_link">
                                        <i class="uk-icon" uk-icon="icon: pencil"></i> <sub><small> Edit</small></sub> 
                                    </a>
                                    <a href="<?=PROOT?>funding/deleteFundCat/<?=$val->id?>" class="uk-text-danger no_link" onclick="if(!confirm('Are You Sure?')){ return false;}">
...
<div class="circle-btn uk-position-fixed uk-position-medium uk-position-bottom-right">
    <a href="<?=PROOT?>funding/addFundCat" class="uk-button uk-button-text no_link" type="submit" uk-tooltip="title: Add New; pos:left">
...
<script>
    $(document).ready(function(){
        ...
        $("#delete_all").click(function (e) {
            ...
            $.ajax({
                url : PROOT+"funding/deletemultipleFundCat/delete_data",
