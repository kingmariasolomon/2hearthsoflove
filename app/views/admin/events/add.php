...
<section class="uk-section uk-section-xsmall uk-dark">
    <div class="section-heading uk-margin-bottom">
        <div class="uk-container">
            <h2 class="uk-heading-bullet"><span class="txt-grad3">Editing An Event</h2>  
        </div>
    </div>
                ...
                <div class="uk-grid-small" uk-grid>
                    <div class="uk-width-1-3">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            ...
                            <?= FH::selectBlock("Type Of Event", 'type', ["Event"=>"Event","News"=>"News"], ["class"=>"uk-form-controls"], $labelAttrs=[], ["class"=>"uk-select"], ["class"=>"uk-margin uk-margin-remove-top"]);?>
                        </div>
                    </div>
                    <div class="uk-width-2-3">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded" style="min-height:200px">
                            <?= FH::fileInputBlock('file', 'Upload', 'pix','icon=file-text=1.5', ['class'=>'uk-margin']);?><button id="clear-preview-images" class="uk-button uk-button-close" type="button" style="background: #00000038;margin: 3px;height:50px;" uk-tooltip="Clear All Preview Image" uk-close></button>
