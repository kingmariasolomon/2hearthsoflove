                    ...
                    <table class="uk-table uk-table-divider uk-table-striped uk-table-hover">
                        ...
                        <?php foreach($this->users as $key => $val): ?>
                            <tr>
                                ...
                                <td><?=$val->pix;?></td>
                                <td>
                                    <!-- <a href="<?=PROOT?>admin/editbranches/<?=$val->id?>" class="uk-text-success no_link">
                                        <i class="uk-icon" uk-icon="icon: pencil"></i> <sub><small> Edit</small></sub> 
                                    </a> -->
                                    <a href="<?=PROOT?>admin/users/<?=$val->id?>" class="uk-text- no_link" onclick="if(!confirm('Are You Sure?')){ return false;}">
