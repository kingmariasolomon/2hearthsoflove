...
<section class="uk-section uk-section-xsmall uk-dark">
    <div class="section-heading uk-margin-bottom">
        <div class="uk-container">
            <h2 class="uk-heading-bullet"><span class="txt-grad3"> Media Sub Categories</h2>
                    ...
                    <table class="uk-table uk-table-divider">
                        ...
                        <?php foreach($this->categories as $key => $val): ?>
                            <tr>
                                ...
                                <td><?=$val->date;?></td>
                                <td>
                                    <a href="<?=PROOT?>media/mediaeditsubcategory/<?=$val->id?>" class="uk-text-success no_link">
                                        <i class="uk-icon" uk-icon="icon: pencil"></i> <sub><small> Edit</small></sub> 
                                    </a>
                                    <a href="<?=PROOT?>media/mediadeletesubcategory/<?=$val->id?>" class="uk-text-danger no_link" onclick="if(!confirm('Are You Sure?')){ return false;}">
...
<div class="circle-btn uk-position-fixed uk-position-medium uk-position-bottom-right">
    <a href="<?=PROOT?>media/mediaaddsubcategory" class="uk-button uk-button-text no_link" type="submit" uk-tooltip="title: Add New; pos:left">
...
<script>
    $(document).ready(function(){
        ...
        $("#delete_all").click(function (e) {
            ...
            $.ajax({
                url : PROOT+"media/mediadeletemultiplesubcategory/delete_data",
