                ...
                <div class="uk-width-1-1">
                    <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                        <form id="form_about" class="uk-form-stacked uk-margin-medium-left uk-margin-medium-right" action="<?=$this->postAction?>" method="post" enctype="multipart/form-data">
                            ...
                            <?= FH::textAreaBlock('Your message', 'about_org','', ['class'=>'uk-form-label'], ['class'=>'uk-textarea uk-border-rounded', 'rows'=>'25', 'placeholder'=>'Enter Your Message...'], ['class'=>'uk-margin']);?>
