...
<section class="uk-section uk-section-xsmall uk-dark">
    <div class="section-heading uk-margin-bottom">
        <div class="uk-container">
            <h2 class="uk-heading-bullet"><span class="txt-grad3">Add New Blog</h2>  
        </div>
    </div>
                        ...
                        <form id="form_branch" class="uk-form-stacked uk-margin-medium-left uk-margin-medium-right" action="<?=$this->postAction?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="uk-child-width-1-1@s uk-margin-medium" uk-grid>
                                <div class="uk-width-2-3@m">
                                    <?= FH::inputBlock('text', 'Blog Title', 'title','', ['class'=>'uk-form-controls'], ['class'=>'uk-form-label'], ['class'=>'uk-input uk-border-rounded'], ['class'=>'uk-margin']);?>
                                    
                                    <?= FH::fileInputBlock('file', 'Upload', 'pix','icon=file-text=1.5', ['class'=>'uk-margin']);?>
                                    <button id="clear-preview-images" class="uk-button uk-button-close" type="button" style="background: #00000038;margin: 3px;height:50px;" uk-tooltip="Clear All Preview Image" uk-close></button>
                                    <div id="image-preview-container"></div>
                                </div>
                                <div class="uk-width-1-3@m">
                                <?= FH::selectBlock("Choose A Category", 'cat_id', $this->categories, ["class"=>"uk-form-controls"], $labelAttrs=[], ["class"=>"uk-select"], ["class"=>"uk-margin uk-margin-remove-top"]);?>
                                </div>
                            </div>

                            <?= FH::textAreaBlock('Your message', 'body','', ['class'=>'uk-form-label'], ['class'=>'uk-textarea uk-border-rounded', 'rows'=>'25', 'placeholder'=>'Enter Your Message...'], ['class'=>'uk-margin']);?>
