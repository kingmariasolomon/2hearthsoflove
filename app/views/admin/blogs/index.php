...
<section class="uk-section uk-section-xsmall uk-dark">
    <div class="section-heading uk-margin-bottom">
        <div class="uk-container">
            <h2 class="uk-heading-bullet"><span class="txt-grad3">Blogs</h2> 
                    ...
                    <table class="uk-table uk-table-divider">
                        ...
                        <?php foreach($this->blogs as $key => $val): ?>
                            <tr>
                                ...
                                <td><?=$val->title;?></td>
                                <td class="switchElement" value="<?=$val->approved?>" url="blog/approveBlog/<?=$val->id?>"><?=($val->approved==1)? "Active": "InActive";?></td>
                                <td>
                                    <a href="<?=PROOT?>blog/editblog/<?=$val->id?>" class="uk-text-success no_link">
                                        <i class="uk-icon" uk-icon="icon: pencil"></i> <sub><small> Edit</small></sub> 
                                    </a>
                                    <a href="<?=PROOT?>blog/deleteblog/<?=$val->id?>" class="uk-text-danger no_link" onclick="if(!confirm('Are You Sure?')){ return false;}">
...
<div class="circle-btn uk-position-fixed uk-position-medium uk-position-bottom-right">
    <a href="<?=PROOT?>blog/addblog" class="uk-button uk-button-text no_link" type="submit" uk-tooltip="title: Add New; pos:left">
...
<script>
    $(document).ready(function(){
        ...
        $("#delete_all").click(function (e) {
            ...
            $.ajax({
                url : PROOT+"blog/deletemultipleblogs/delete_data",
